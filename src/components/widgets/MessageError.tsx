...
export const MessageError: FC<{ message?: any, className?: string, divClassName?: string }> = ({ message, className = "text-red-600 text-xs", divClassName = "inline-flex mt-2 space-x-1 w-full items-center" }) => {
    if (!message) return <></>

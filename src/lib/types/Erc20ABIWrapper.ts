...
export type ContractContext = Web3ContractContext<
  Erc20ABIWrapper,
  Erc20ABIWrapperMethodNames,
  Erc20ABIWrapperEventsContext,
  Erc20ABIWrapperEvents
>;
export type Erc20ABIWrapperEvents = 'Approval' | 'Transfer';
export interface Erc20ABIWrapperEventsContext {
  Approval(
    parameters: {
...
export type Erc20ABIWrapperMethodNames =
  | 'name'
  | 'approve'
  | 'totalSupply'
  | 'transferFrom'
...
export interface Erc20ABIWrapper {
  /**
   * Payable: false
   * Constant: true
